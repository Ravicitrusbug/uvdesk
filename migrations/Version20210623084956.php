 ...
 */
final class Version20210623084956 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE uv_support_company (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(191) NOT NULL, description LONGTEXT NOT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) DEFAULT \'0\' NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE uv_support_groups_companies (supportGroup_id INT NOT NULL, supportCompany_id INT NOT NULL, INDEX IDX_4211EA4ECE5F5290 (supportGroup_id), INDEX IDX_4211EA4E238823AD (supportCompany_id), PRIMARY KEY(supportGroup_id, supportCompany_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE uv_support_groups_companies ADD CONSTRAINT FK_4211EA4ECE5F5290 FOREIGN KEY (supportGroup_id) REFERENCES uv_support_group (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE uv_support_groups_companies ADD CONSTRAINT FK_4211EA4E238823AD FOREIGN KEY (supportCompany_id) REFERENCES uv_support_company (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE uv_ticket_status_log CHANGE user_id user_id INT DEFAULT NULL, CHANGE ticket_id ticket_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE uv_support_groups_companies DROP FOREIGN KEY FK_4211EA4E238823AD');
        $this->addSql('DROP TABLE uv_support_company');
        $this->addSql('DROP TABLE uv_support_groups_companies');
