 ...
 */
final class Version20210531074715 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE uv_tickets_organizations (ticket_id INT NOT NULL, organization_id INT NOT NULL, INDEX IDX_20D7CF91700047D2 (ticket_id), INDEX IDX_20D7CF9132C8A3DE (organization_id), PRIMARY KEY(ticket_id, organization_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE uv_tickets_organizations ADD CONSTRAINT FK_20D7CF91700047D2 FOREIGN KEY (ticket_id) REFERENCES uv_ticket (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE uv_tickets_organizations ADD CONSTRAINT FK_20D7CF9132C8A3DE FOREIGN KEY (organization_id) REFERENCES uv_support_team (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE uv_tickets_organizations');
