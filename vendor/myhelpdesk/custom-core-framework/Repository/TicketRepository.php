        ...
        foreach ($params as $field => $fieldValue) {
            ...
            switch ($field) {
                ...
                case 'search':
                    ...
                    $queryBuilder->andwhere("company LIKE :search OR ticket.subject LIKE :search OR ticket.id  LIKE :search OR customer.email LIKE :search OR CONCAT(customer.firstName,' ', customer.lastName) LIKE :search OR agent.email LIKE :search OR CONCAT(agent.firstName,' ', agent.lastName) LIKE :search");
